            ...
            <div class="row tm-catalog-item-list">
                <div class="col-lg-4 col-md-6 col-sm-12 tm-catalog-item">
                    <div class="position-relative tm-thumbnail-container">
                        ...
                        <!-- http://youtube.com/watch?v=IODxDxX7oi4 -->
                            <i class="fas fa-play tm-overlay-icon"></i>
                        </a>
                    </div>
                    <div class="p-4 tm-bg-gray tm-catalog-item-description">
                        <h3 class="tm-text-primary mb-3 tm-catalog-item-title" style="color: #ffc107;">Push Up yang sempurna - Lakukan dengan benar!</h3>
                        <p class="tm-catalog-item-text" style="text-align: justify;">Video ini merupakan video tutorial Push Up dengan gerakan-gerakan yang benar dan langsung dimentori oleh instruktor professional loh!</p>
                    </div>
                </div>
            </div>
        </main>
