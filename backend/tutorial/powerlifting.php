...
<!-- ======= Header ======= -->
	<header id="header" class="fixed-top header-transparent">
		<div class="container d-flex align-items-center justify-content-between">
		    <a href="http://prak11billy2-com.preview-domain.com/backend/indexutama.php" class="logo">
					...
					<div class="row mb-5 pb-4">
						<div class="col-12">
							...
							<video width="1422" height="800" controls autoplay>
								<source src="assets/video/PowerLifting1.mp4" type="video/mp4">							  
							Your browser does not support the video tag.
							</video>
						</div>
					</div>
					
				<section id="powerlifting" class="d-flex align-items-center justify-content-center"></section>
					<div class="row mb-5 pb-5">
						<div class="col-xl-8 col-lg-7">
							<!-- Video description -->
							<div class="tm-video-description-box">
								<h2 class="mb-5 tm-video-title">Apa itu Pull / Push Powerlifting?</h2>
<p class="mb-4" style="text-align: justify;">Powerlifting adalah olahraga kekuatan murni - ujian kemampuan seseorang untuk bergerak sebanyak mungkin dalam tiga latihan yang berbeda: squat, bench press, dan deadlift. Bersama-sama ketiga gerakan tersebut merupakan pertemuan powerlifting penuh, catat USA powerlifting, salah satu federasi powerlifting terbesar di negara ini. Namun, Anda dapat memilih untuk tidak bersaing di beberapa acara. Jika Anda hanya bersaing di bench press dan deadlift, Anda berpartisipasi dalam kompetisi tarik / dorong.</p>
							</div>							
						</div>
