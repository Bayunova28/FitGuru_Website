...
<section id="home" class="d-flex align-items-center justify-content-center">
    <div class="container position-relative">
        ...
        <a href="#bodybuilding" class="btn-get-started scrollto">Get Started</a>
    </div>
</section>
<!-- End Hero Section -->

<!-- TUTORIAL -->
<section id="bodybuilding" class="d-flex align-items-center justify-content-center">
            ...
            <div class="row tm-catalog-item-list">
                <div class="col-lg-4 col-md-6 col-sm-12 tm-catalog-item">
                    <div class="position-relative tm-thumbnail-container">
                        ...
                        <!-- https://www.youtube.com/watch?v=XtxQPrABLyo -->
                    ...
                    <div class="p-4 tm-bg-gray tm-catalog-item-description">
                        ...
                        <p class="tm-catalog-item-text" style="text-align: justify;">Untuk kamu yang lagi mau melakukan Body Building, bisa banget cek video ini! Video ini merupakan video tutorial untuk melakukan Body Building serta memotivasi kamu untuk terus melakukan body building!</p>
                    </div>
                </div>
            </div>
        </main>
