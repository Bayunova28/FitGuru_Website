...
<section id="home" class="d-flex align-items-center justify-content-center">
    <div class="container position-relative">
        ...
        <a href="#tutorial" class="btn-get-started scrollto">Get Started</a>
    </div>
</section>
<!-- End Hero Section -->

<!-- TUTORIAL -->
<section id="tutorial" class="d-flex align-items-center justify-content-center">
                ...
                <div class="row tm-catalog-item-list">
                    <div class="col-lg-4 col-md-6 col-sm-12 tm-catalog-item">
                        ...
                        <div class="p-4 tm-bg-gray tm-catalog-item-description">
                            <h3 class="tm-text-primary mb-3 tm-catalog-item-title" style="color:  #ffc107;">WAJIB ! Yoga Sebelum Tidur - Yoga With Penyogastar</h3>
                                <p class="tm-catalog-item-text" style="text-align: justify;">Hi Yogis! Lelah aktivitas diluar membuat tubuh menjadi lelah. Ada baiknya jika kamu melakukan Yoga sebelum tidur agar tidur lebih nyenyak dan juga menyehatkan tubuh. So, buat kamu jangan males malesan lagi buat ngelakuin hal yang positif demi kesehatan. Karena kesehatan itu penting lho!
                                </p>
                            </div>
                        </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 tm-catalog-item">
                        ...
                        <div class="p-4 tm-bg-gray tm-catalog-item-description">
                            <h3 class="tm-text-primary mb-3 tm-catalog-item-title" style="color:  #ffc107;">Push Up yang sempurna - Lakukan dengan cara yang tepat dan benar!</h3>
                            <p class="tm-catalog-item-text" style="text-align: justify;">Video ini merupakan video tutorial Push Up dengan gerakan-gerakan yang benar dan langsung dimentori oleh instruktor professional loh!
                            </p>
                        </div>
                    </div>
                <div class="col-lg-4 col-md-6 col-sm-12 tm-catalog-item">
                    ...
                    <div class="p-4 tm-bg-gray tm-catalog-item-description">
                        <h3 class="tm-text-primary mb-3 tm-catalog-item-title" style="color:  #ffc107;">4 YEARS OF NATURAL BODYBUILDING // GYM MOTIVATION</h3>
                        <p class="tm-catalog-item-text" style="text-align: justify;">Untuk kamu yang lagi mau melakukan Body Building, bisa banget cek video ini! Video ini merupakan video tutorial untuk melakukan Body Building serta memotivasi kamu untuk terus melakukan body building!
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 tm-catalog-item">
                    ...
                    <div class="p-4 tm-bg-gray tm-catalog-item-description">
                        <h3 class="tm-text-primary mb-3 tm-catalog-item-title" style="color:  #ffc107;">POWERLIFTING FOR BEGINNERS - First</h3>
